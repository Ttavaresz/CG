...
// img.src = './terrain/rocky/RuggedTerrain_hightmap.png';
...
function run() {
  ...
  const maxAngle = 500 * Math.PI / 180;  // make them facetted
  ...
  const texture = twgl.createTexture(gl, {
    src: './terrain/heightmap_texture.jpg',
    // src: './terrain/rocky/RuggedTerrain_texture.png',
    crossOrigin: '',
  });
